	...
	public function Print_event(){
		...
		<div class="event_description evcal_eventcard lightboxik" id="lightboxik" style="display: none;">
			...
			<div class="evo_metarow_details evorow evcal_evdata_row bordb evcal_event_details">
				<div class="event_excerpt" style="display:none"><h3 class="padb5 evo_h3">' . __( 'Details', 'fb-display-events-shortcode' ) . '</h3><p>' . $this->Get_description_excerpt() . '[...]</p>
				</div>
				<span class="evcal_evdata_icons"><i class="fa fa-align-justify"></i></span>
				<div class="evcal_evdata_cell shorter_desc" orhei="150" style="">
					<div class="fdes_details_shading_bot">
					...
					<div class="fdes_full_description">
						<h3 class=" evo_h3">' . __( 'Details', 'fb-display-events-shortcode' ) . '</h3>
						<div class="fdes_desc_in" itemprop="description">
