...
If you dont need full place addres try to replace word 'place' with 'location' in fb-display-events-shortcode.php
Replace 
$fields="id,name,description,place,timezone,start_time,cover";
with
$fields="id,name,description,location,timezone,start_time,cover";
or
$fields="id,name,description,timezone,start_time,cover";
...
= 1.2 = 
Fixed missing </div> in Print_event function
